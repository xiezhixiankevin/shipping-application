...
public class JwtDemo {
    ...
    //jwt签发者
    private final static String jwt_iss = "zxxie";

    //jwt所有人
    private final static String subject = "xiezx";
     ...
     *      返回生成的jwt token
     */
    public static String generateJwtToken(Map<String,String> infoMap){
     ...
     * @return
     */
    public static String getByKey(String key,String token){
