...
@Slf4j
public class OwnerAuthorizeFilter implements GlobalFilter, Ordered {

    public final static String ATTRIBUTE_IGNORE_OWNER_AUTHORIZE_GLOBAL_FILTER = "@IgnoreOwnerAuthorizeGlobalFilter";
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (exchange.getAttribute(ATTRIBUTE_IGNORE_OWNER_AUTHORIZE_GLOBAL_FILTER) != null) {
            return chain.filter(exchange);
        }
