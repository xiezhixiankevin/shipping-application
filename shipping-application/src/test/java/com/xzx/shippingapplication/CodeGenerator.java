 ...
 * @author 26802
 * @version 1.0
 * @see com.example.shippingapplication
 */
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("com.xzx.shippingapplication");
        pc.setMapper("mapper");
        ...
        TableFill gmt_modified = new TableFill("update_timestamp", FieldFill.INSERT_UPDATE);
